...
class GiftViewController : UIViewController,UITableViewDelegate, UITableViewDataSource, DataDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath)
    {
        ...
        var giftInfoVC:GiftInfoController = GiftInfoController()
        giftInfoVC.hidesBottomBarWhenPushed = false
        giftInfoVC.gift = gift
        self.navigationController!.pushViewController(giftInfoVC, animated: true)
    }
